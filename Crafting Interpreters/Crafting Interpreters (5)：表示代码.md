...
```ruby
class Lox::Ast::Expr; end

class Lox::Ast::Binary < Lox::Ast::Expr
  attr_reader :op, :left, :right, :location

  def initialize(op:, left:, right:, location: nil)
    @op = op
    @left = left
    @right = right
    @location = location
...
Literal = Struct.new(:type, :value)
Unary = Struct.new(:type, :op, :right)
Binary = Struct.new(:type, :op, :left, :right)
...
def binary(op, left, right)
  Binary.new(:binary, op, left, right)
end
...
expr = Lox::Ast::Binary.new(
  op: Lox::Token.new(type: Lox::TokenType::STAR, lexeme: "*"),
  left: Lox::Ast::Unary.new(
    op: Lox::Token.new(type: Lox::TokenType::MINUS, lexeme: "-"),
    right: Lox::Ast::Literal.new(value: 123)),
  right: Lox::Ast::Group.new(
