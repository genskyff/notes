...
```shell
brew upgrade
brew install bat bottom choose-rust curl difftastic doggo duf dust fastfetch fd fish fzf git-delta helix hyperfine lazydocker lazygit lsd mise nushell ripgrep sd starship tlrc tokei wget zellij zoxide
```
