...
恶意软件将会在不知觉的情况下，连接到分析机而不是 Internet。同时以知名勒索软件 [WannaCry](https://zh.m.wikipedia.org/zh-hans/WannaCry) 为例进行简单的分析。
...
Windows ISO 可以去 [ITELLYOU](https://next.itellyou.cn/) 下载，然后在虚拟机中安装。如果嫌麻烦，也可以去 [Microsoft Edge Developer](https://developer.microsoft.com/en-us/microsoft-edge/tools/vms/) 下载打包好了的虚拟机文件，然后直接在虚拟机中打开即可，但版本较旧，不是特别推荐。
...
由于 Burp Suite 社区版没有保存项目的功能，因此需要将本次的配置文件保存下来，方便下次使用时直接导入。

![保存配置](https://raw.githubusercontent.com/genskyff/image-hosting/main/images/202205160437184.png)
